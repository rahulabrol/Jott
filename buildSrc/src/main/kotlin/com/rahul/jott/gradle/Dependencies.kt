...
object Version {
    ...
    const val webContent = "1.2.3"
    const val oneTrust = "1.1.9"
    const val otPublisher = "202303.2.0.0"
    const val security = "1.1.4"
    ...
    const val aceExperiments = "1.5.5"
    const val aceCore = "1.5.2"
    const val inAppUpgrade = "1.1.3"
    const val javalite = "3.22.3"
    const val analytics = "1.4.4"
    const val analyticsFirebase = "1.3.5"
    const val analyticsCore = "1.3.5"
    const val logging = "1.1.9"
...
object Library {
    object Plugin {
        ...
        const val navigationSafeArg =
            "androidx.navigation:navigation-safe-args-gradle-plugin:${Version.Androidx.navigation}"
    ...
    object Androidx {
        object Test {
            ...
            const val uiautomator =
                "androidx.test.uiautomator:uiautomator:${Version.Androidx.testUiAutomator}"
            const val espresso =
                "androidx.test.espresso:espresso-core:${Version.Androidx.espresso}"
            const val testRunner = "androidx.test:runner:${Version.Androidx.testRunner}"
        }

        const val startup =
            "androidx.startup:startup-runtime:${Version.Androidx.appStartup}"
        const val liveData =
            "androidx.lifecycle:lifecycle-livedata-ktx:${Version.Androidx.lifecycle}"
        const val viewModel =
            "androidx.lifecycle:lifecycle-viewmodel-ktx:${Version.Androidx.lifecycle}"
        ...
        const val hiltNavigationCompose =
            "androidx.hilt:hilt-navigation-compose:${Version.Androidx.hiltNavigationCompose}"
        const val navigationUIKtx =
            "androidx.navigation:navigation-ui-ktx:${Version.Androidx.navigation}"
        const val navigationTesting =
            "androidx.navigation:navigation-testing:${Version.Androidx.navigation}"
        ...
        const val protobufDataStore = "androidx.datastore:datastore:${Version.Androidx.dataStore}"
        const val preferenceDataStore =
            "androidx.datastore:datastore-preferences:${Version.Androidx.dataStore}"
    ...
    object GooglePlayServices {
        const val location =
            "com.google.android.gms:play-services-location:${Version.googlePlayServicesLocation}"
        const val gmsTasks =
            "com.google.android.gms:play-services-tasks:${Version.googlePlayServicesTasks}"
    }
    ...
    object Kotlin {
        ...
        const val kotlinXCollections =
            "org.jetbrains.kotlinx:kotlinx-collections-immutable-jvm:${Version.kotlinXCollections}"
    }
    ...
    object Firebase {
        const val firebaseBillOfMaterials =
            "com.google.firebase:firebase-bom:${Version.firebaseBoM}"
        const val firebaseConfig = "com.google.firebase:firebase-config"
        const val firebaseAnalytics = "com.google.firebase:firebase-analytics"
        const val firebaseCrashlytics =
            "com.google.firebase:firebase-crashlytics-gradle:${Version.firebaseCrashlyticsPlugin}"
    }
